...
{ return expression_tree(x, y, op_element(BINARY, OP), DTYPE); }\
\
\
...
{ return expression_tree(y, x, op_element(BINARY, OP), DTYPE); } \
\
...
{ return expression_tree(y, x, op_element(BINARY, OP)); }
